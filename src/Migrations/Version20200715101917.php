 ...
 */
final class Version20200715101917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74789 ON user (email)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74789 ON user');
    }
}
